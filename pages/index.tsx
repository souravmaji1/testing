    ...
    <div>
      ...
      <div className={styles.homepageBlack}>
          ...
          <div className={styles.groupParent}>
            <div className={styles.downloadOurWhitePaperForIParent}>
              <div style={thirdFont.style} className={styles.downloadOurWhite1}>
                Download Our White Paper for In-Depth Insights
              </div>
              <div style={secondFont.style} className={styles.diveIntoThe1}>
                ...
                revolutionary features, innovative functionalities, and the
                vision that drives our project forward. Stay ahead of the curve
                and explore the potential that awaits. Download now and embark
                on a journey of knowledge and innovation. 🚀
              </div>
            </div>
        ...
        <div style={secondFont.style} className={styles.elevateYourFinancial1}>
          Elevate your financial experience with Coliseum DApp – where
          decentralized power meets security, offering cross-border transactions
          and smart contract capabilities for a future-forward journey.
        </div>
        ...
        <div style={secondFont.style} className={styles.joinAPlatform1}>
          ...
          financial systems and the digital world, ensuring access to financial
          services for all.
        </div>
        ...
        >
          Experience enhanced security through blockchain technology, providing
          tamper-resistant records and advanced encryption to protect your data
          and transactions
        </div>
        <div
          style={secondFont.style}
        ...
        <div style={secondFont.style} className={styles.benefitFromLower1}>
          Benefit from lower transaction fees compared to traditional financial
          systems, maximizing the value of your transactions
        </div>
        <div style={secondFont.style} className={styles.sendAndReceive1}>
          Send and receive funds globally without the complexities of
          traditional banking systems, making international transactions faster
        ...
        <div className={styles.joinOurCommunityParent}>
          ...
          <div style={secondFont.style} className={styles.diveIntoA1}>
            ...
            with us to shape the future of finance through Coliseum DApp. Your
        ...
        >{`Treasury & Tokens Ecosystem`}</div>
        <div style={secondFont.style} className={styles.immerseYourselfIn1}>
          The core of our treasury is anchored in tax credits and country bonds,
          two assets that offer both stability and appreciable benefits:{" "}
        </div>
