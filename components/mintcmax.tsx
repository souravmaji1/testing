...
export default function Minting() {
  ...
  <TabList className={styles.swapMintburnItem} sx={{padding:'10px 20px 10px 20px'}}   >
    <Tab style={thirdFont.style}   sx={{height:'54px',padding:'10px 50px 10px 50px',borderRadius:'7px',margin:'auto'}}    _selected={{ color: 'black', bg: 'yellow' }}>Buy CMAX</Tab>
  ...
  <TabPanels>
	...
	<Button style={{textTransform:'none',fontFamily:'__thirdFont_3ea4f2',fontSize:'21px'}}     sx={{color:'black'}}  onClick={handleClickOpen}>
        Buy Using Cards
      </Button>
